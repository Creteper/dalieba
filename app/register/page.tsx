    ...
    <div className="min-h-screen w-full overflow-hidden relative">
      ...
      >
        ...
        <div className="w-full space-y-4">
          ...
          <div className="space-y-2">
            <div className="relative flex items-center">
              <Phone className={cn(errors.phone ? "text-destructive" : "text-muted-foreground", "absolute left-3 w-5 h-5 pointer-events-none")} />
              <Input 
            ...
            {errors.phone && (
              <div className="text-destructive text-sm px-1">{errors.phone}</div>
            )}
          </div>
